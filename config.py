...
def _abs_path(value: str, default: str) -> str:
    """Возвращает абсолютный путь, даже если в окружении передан относительный."""
...
LOCAL_BOT_API_CACHE_DIR = _abs_path(
    os.getenv("LOCAL_BOT_API_CACHE_DIR"), "/opt/bespilotnik/data/telegram_files"
)
NGROK_PUBLIC_URL = os.getenv("NGROK_PUBLIC_URL", "https://10bdf31051e0.ngrok-free.app")  # Замени на адрес от ngrok
WEBHOOK_PATH = os.getenv("WEBHOOK_PATH", "/webhook")
PUBLIC_MEDIA_ROOT = _abs_path(
    os.getenv("PUBLIC_MEDIA_ROOT"), "/opt/bespilotnik/data"
)
